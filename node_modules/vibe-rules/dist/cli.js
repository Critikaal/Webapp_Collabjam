...
program
    .name("vibe-rules")
    .description("A utility for managing Cursor rules, Windsurf rules, Amp rules, and other AI prompts")
...
program
    ...
    .argument("<editor>", "Target editor type (cursor, windsurf, claude-code, gemini, codex, amp, clinerules, roo, zed, unified, vscode)")
...
program
    .command("install")
    .description("Install rules from an NPM package or all dependencies directly into an editor configuration")
    .argument("<editor>", "Target editor type (cursor, windsurf, claude-code, gemini, codex, amp, clinerules, roo, zed, unified, vscode)")
...
program
    ...
    .argument("<sourceFormat>", "Source format (cursor, windsurf, claude-code, gemini, codex, amp, clinerules, roo, zed, unified, vscode)")
    .argument("<targetFormat>", "Target format (cursor, windsurf, claude-code, gemini, codex, amp, clinerules, roo, zed, unified, vscode)")
...
program
    ...
    .argument("<editor>", "Target editor type (cursor, windsurf, claude-code, codex, amp, clinerules, roo, zed, unified, vscode)")
