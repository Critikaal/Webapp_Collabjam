...
export class CodexRuleProvider {
    constructor() {
        this.ruleType = RuleType.CODEX;
    }
    /**
    ...
    async appendFormattedRule(config, targetPath, isGlobal, options) {
        ...
        return appendOrUpdateTaggedBlock(targetPath, config, options, true // Append inside <vibe-rules Integration>
        );
    }
    /**
