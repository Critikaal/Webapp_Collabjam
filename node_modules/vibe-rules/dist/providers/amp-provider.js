...
export class AmpRuleProvider {
    constructor() {
        this.ruleType = RuleType.AMP;
    }
    /**
    ...
    async appendFormattedRule(config, targetPath, isGlobal, options) {
        ...
        return appendOrUpdateTaggedBlock(targetPath, config, options, false // No special integration block needed for Amp
        );
    }
    /**
...
//# sourceMappingURL=amp-provider.js.map