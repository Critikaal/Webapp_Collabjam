 ...
 */
export function formatRuleWithMetadata(config, options) {
    ...
    if (options?.alwaysApply !== undefined) {
        metadataLines.push(`Always Apply: ${options.alwaysApply ? "true" : "false"} - ${options.alwaysApply
    ...
    if (options?.globs && options.globs.length > 0) {
        ...
        const isCatchAllPattern = globsStr === "**/*" ||
