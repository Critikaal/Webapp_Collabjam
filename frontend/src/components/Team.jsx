        ...
        <div className="card">
          ...
          <div className="shortcut-grid">
            <div className="shortcut">
              <h3>Tegn</h3>
              <img src="../src/assets/img/pfp.jpg" alt="Tegn" />
            </div>
            <div className="shortcut">
              <h3>Søk</h3>
            ...
            <div className="shortcut">
              <h3>Idéer</h3>
              <img src="../src/assets/img/pfp.jpg" alt="Ideer" />
            </div>
          </div>
        </div>
      ...
      <div className="col-right">
        ...
        <div className="card">
          ...
          <div className="member">
            <img src="../src/assets/img/pfp.jpg" alt="Oskar" />
            <span>Oskar</span>
          </div>

          <h3 className="role">🥈 Nest-leder</h3>
          <div className="member">
            <img src="../src/assets/img/pfp.jpg" alt="Jonas" />
            <span>Jonas</span>
          </div>

          <h3 className="role">👨‍👩‍👧‍👦 Andre</h3>
          <div className="member">
            <img src="../src/assets/img/pfp.jpg" alt="Person 1" />
            <span>Person 1</span>
          </div>
          <div className="member">
            <img src="../src/assets/img/pfp.jpg" alt="Person 2" />
            <span>Person 2</span>
          </div>
          <div className="member">
            <img src="../src/assets/img/pfp.jpg" alt="Person 3" />
            <span>Person 3</span>
          </div>
          <div className="member">
            <img src="../src/assets/img/pfp.jpg" alt="Person 4" />
            <span>Person 4</span>
          </div>
        </div>
